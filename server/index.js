...
import { Listbox, ListboxItem, Navbar, NavbarBrand, NavbarContent, NavbarItem, Link, Popover, PopoverTrigger, Button, PopoverContent } from "@heroui/react";
...
function SkillsPopover() {
  return /* @__PURE__ */ jsx("div", { className: "purple-dark flex flex-wrap gap-4", children: skills.map((skill) => /* @__PURE__ */ jsxs(Popover, { showArrow: true, backdrop: "opaque", placement: "right", children: [
    /* @__PURE__ */ jsx(PopoverTrigger, { children: /* @__PURE__ */ jsx(Button, { className: "capitalize", color: "primary", variant: "flat", children: skill.name }) }),
    /* @__PURE__ */ jsx(PopoverContent, { className: "w-240px", children: /* @__PURE__ */ jsxs("div", { className: "px-1 py-2 w-full text-primary-500", children: [
      /* @__PURE__ */ jsx("p", { className: "text-small font-bold", children: "Projects used" }),
      /* @__PURE__ */ jsx("ul", { children: projects.filter((project) => skill.projects.includes(project.id)).map((project) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: "#", className: "hover:underline", children: project.name }) }, project.id)) })
    ] }) })
  ] })) });
}
